    ...
    <div class="container mt-3">
        <form action="Actualizar.Proveedor.php" method="post">
            ...
            <div class="mb-3">
                ...
                <input type="number" class="form-control" id="DNI" name="DNI" required maxlength="20"
                    value="<?php echo $row['DNI']; ?>">
            </div>

            <div class="mb-3">
                <label for="CUIT" class="form-label">CUIT</label>
                <input type="number" class="form-control" id="CUIT" name="CUIT" required maxlength="20"
